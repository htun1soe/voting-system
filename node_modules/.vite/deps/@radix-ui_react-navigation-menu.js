...
import {
  createCollection
} from "./chunk-3U5OTLUJ.js";
import {
  useId
} from "./chunk-4D5BC6X4.js";
import {
  DismissableLayer,
  Presence,
  Primitive,
  ...
  useLayoutEffect2
} from "./chunk-R5MM6IPG.js";
import {
  require_react_dom
} from "./chunk-PP3SZYJZ.js";
import {
  require_jsx_runtime
} from "./chunk-6OKPAFOK.js";
import {
  require_react
} from "./chunk-KDIMAABR.js";
import {
  __toESM
...
var NavigationMenu = React3.forwardRef(
  __name3(function NavigationMenu2(props, forwardedRef) {
    const {
...
var NavigationMenuSub = React3.forwardRef(
  ...
  __name3(function NavigationMenuSub2(props, forwardedRef) {
    const {
      __scopeNavigationMenu,
      value: valueProp,
      onValueChange,
...
var NavigationMenuProvider = __name3((props) => {
  const {
    scope,
    isRootMenu,
    rootNavigationMenu,
...
var NavigationMenuList = React3.forwardRef(
  // blank line to reduce diff noise
  __name3(function NavigationMenuList2(props, forwardedRef) {
...
var NavigationMenuItem = React3.forwardRef(
  // blank line to reduce diff noise
  __name3(function NavigationMenuItem2(props, forwardedRef) {
...
var NavigationMenuTrigger = React3.forwardRef(__name3(function NavigationMenuTrigger2(props, forwardedRef) {
...
var NavigationMenuLink = React3.forwardRef(
  // blank line to reduce diff noise
  __name3(function NavigationMenuLink2(props, forwardedRef) {
...
var NavigationMenuIndicator = React3.forwardRef(__name3(function NavigationMenuIndicator2(props, forwardedRef) {
...
var NavigationMenuIndicatorImpl = React3.forwardRef(__name3(function NavigationMenuIndicatorImpl2(props, forwardedRef) {
  ...
  const handlePositionChange = __name3(() => {
    if (activeTrigger) {
      setPosition({
...
var NavigationMenuContent = React3.forwardRef(__name3(function NavigationMenuContent2(props, forwardedRef) {
...
var ViewportContentMounter = React3.forwardRef(__name3(function ViewportContentMounter2(props, forwardedRef) {
  const context = useNavigationMenuContext(CONTENT_NAME, props.__scopeNavigationMenu);
...
var NavigationMenuContentImpl = React3.forwardRef(__name3(function NavigationMenuContentImpl2(props, forwardedRef) {
  const {
    __scopeNavigationMenu,
    value,
    triggerRef,
...
var NavigationMenuViewport = React3.forwardRef(__name3(function NavigationMenuViewport2(props, forwardedRef) {
...
var NavigationMenuViewportImpl = React3.forwardRef(__name3(function NavigationMenuViewportImpl2(props, forwardedRef) {
  ...
  const handleSizeChange = __name3(() => {
...
var NavigationMenuViewportItem = __name3(({
  contentRef,
  isActive,
  onActiveContentChange,
  ...props
}) => {
  const handleContentChange = React3.useCallback(
    (node) => {
      if (isActive && node) {
  ...
  return (0, import_jsx_runtime2.jsx)(NavigationMenuContentImpl, { ...props, ref: composedRefs });
}, "NavigationMenuViewportItem");
var FOCUS_GROUP_NAME = "FocusGroup";
var FocusGroup = React3.forwardRef(
  __name3(function FocusGroup2(props, forwardedRef) {
...
var FocusGroupItem = React3.forwardRef(
  __name3(function FocusGroupItem2(props, forwardedRef) {
    const { __scopeNavigationMenu, ...groupProps } = props;
...
__name3(removeFromTabOrder, "removeFromTabOrder");
...
__name3(useResizeObserver, "useResizeObserver");
